...
export default function sitemap(): MetadataRoute.Sitemap {
  const updated = new Date("2026-08-20T00:00:00+02:00");
  ...
  return [
    ...
    { url: `${SITE_URL}/start-project`, lastModified: updated, changeFrequency: "monthly", priority: 0.9 },
    { url: `${SITE_URL}/support`, lastModified: updated, changeFrequency: "monthly", priority: 0.7 },
    ...caseStudies,
